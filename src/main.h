...
#endif
#define PACKAGE_EXTENDED_VERSION "Elmlor (" PACKAGE_OS \
"; %s; " SDL_NAME "; 4144 v" SMALL_VERSION ")"
#define PACKAGE_VERSION_4144 "Elmlor 4144-" SMALL_VERSION ""

#define FULL_VERSION "Elmlor " SMALL_VERSION " " PACKAGE_OS ", " SDL_NAME
